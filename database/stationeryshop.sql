...
VALUES ('Erasable Gel Pen', 1.95),
	('Heart-Shaped Pencil', 1.95),
	('Fabriano Artist Journal', 16.50),
	('Fabriano Notebook', 5.45),
	('Moleskine classic Agenda', 17.02),
	('Moleskine Harry Potter Agenda', 25.60),
	('Stabilo Pointball', 2.70),
	('Stabilo Kids Pencil', 2.64),
	('Bic sphere', 1.34),
	('Bic cristal', 1.34),
	('Panda timer', 5.60),
	('Purrito mousepad', 10.56);

INSERT INTO product_brand_category(product_id, brand_id, category_id)
VALUES (1, 1, 2),
	(2, 1, 3),
	(3, 2, 1),
	(4, 2, 1),
